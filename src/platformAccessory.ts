...
export class ExamplePlatformAccessory {
  ...
  async getLevel(): Promise<CharacteristicValue> {
    ...
    if (this.ptApi === apiType.localApi) {
      ...
      currentValue = (ad - zero) * this.accessory.context.device.calFactor;
      ...
      currentValue = data.percentLevel;
    }
    this.platform.log.debug(this.accessory.context.device.exampleDisplayName, currentValue);
